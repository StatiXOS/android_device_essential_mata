...
/dev/block/platform/soc/1da4000.ufshc/by-name/userdata  /data              ext4   nosuid,nodev,noatime,barrier=1,noauto_da_alloc                                                       wait,check,latemount,fileencryption=ice,reservedsize=128M
